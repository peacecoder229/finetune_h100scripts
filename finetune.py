...
training_config = {
    ...
    #"output_dir": "./checkpoint_dir",
    #"output_dir": "./checkpoint_dir_cpu",
    "output_dir": "./checkpoint_gpu0",
...
model_kwargs = dict(
    ...
    #remove flash attention for CPU
...
sys.exit(0)
#reduce number of test data sets

processed_test_dataset = processed_test_dataset.select(range(150))
print(processed_test_dataset)
...
#metrics["eval_samples"] = int(0.1*len(processed_test_dataset))
